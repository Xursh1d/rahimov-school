  ...
  return (
    <tr className="bg-white border-b border dark:bg-gray-800 dark:border-gray-700">
      ...
      <td
        ...
        className="border text-center p-2 text-blue-500 hover:bg-blue-50 cursor-pointer"
      >
        {updateLoading ? (
          <svg
            aria-hidden="true"
      ...
      <td
        ...
        className="border text-center p-2 text-red-500 hover:bg-red-50 cursor-pointer"
      >
        {loading ? (
          <svg
            aria-hidden="true"

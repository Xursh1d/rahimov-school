      ...
      <tr className="bg-white border-b border">
        ...
        <td className="border w-[10%]  text-center px-3 py-0 h-full xs:text-[10px] sm:text-sm">
          <button
            ...
            className="m-1 text-white text-center bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm  px-2 py-2 "
          >
            <svg

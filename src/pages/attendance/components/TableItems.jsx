          ...
          <td key={date.date} className="border">
            <select
              ...
              className={`sm:p-2.5 xs:p-1 h-full bg-inherit xs:text-[10px] sm:text-sm  ${formik.touched.students?.[index]?.attendance_data?.[indexDate]
                ...
                }   min-w-[50px] xs:text-[10px] sm:text-sm  outline-none text-center  border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full`}
            >
